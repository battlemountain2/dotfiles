...
-- Natural (Mac-style) scrolling on the touchpad.
hl.config({
  input = {
    touchpad = {
      natural_scroll = true,
...
-- 3-finger horizontal swipe switches workspaces (1:1 follow, like macOS spaces).
hl.gesture({ fingers = 3, direction = "horizontal", action = "workspace" })

-- 3-finger swipe up/down opens/closes Mirador's workspace overview.
-- Scratchpad gave up this gesture -- it's still reachable via SUPER+S.
